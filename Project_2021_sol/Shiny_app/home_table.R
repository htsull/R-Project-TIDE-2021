...
<table border="0" cellpadding="0" cellspacing="0" width="auto" style="border-collapse:
 collapse;table-layout:fixed ;width:auto">
  ...
  <colgroup>
    <col width=auto span="2" style="mso-width-source:userset;mso-width-alt:7862;
       width:161pt">
  ...
  <tbody>
    ...
    <tr height="20" style="height:15.0pt">
      ...
      <td colspan="4" rowspan="2" height="40" class="xl66" width="860"
        style="height:30.0pt; width:644pt;display:table-cell">
    ...
    <tr height="76" style="height:57.0pt">
      <td height="76" class="xl67" width="auto" style="height:57.0pt;width:161pt;  display:table-cell">
        <div style="margin-right:10px">Year Published</div>
      </td>
      <td class="xl70" width="215" style="width:161pt">
        <div style="margin-right:10px">{year}</div>
      </td>
    ...
    <tr height="38" style="height:28.5pt">
      <td height="38" class="xl68" width="215" style="height:28.5pt;border-top:none; width:161pt;display:table-cell">
        <div style="margin-right:10px">Genre</div>
      </td>
      <td class="xl71" width="215" style="border-top:none;width:161pt">
        <div style="margin-right:10px">{genre}</div>
      </td>
      <td class="xl68" width="215" style="border-top:none;width:161pt">
        <div style="margin-right:10px">Writer(s)</div>
      </td>
      <td class="xl71" width="215" style="border-top:none;width:161pt">
    ...
    <tr height="76" style="height:57.0pt">
      <td height="76" class="xl68" width="215" style="height:57.0pt;border-top:none; width:161pt;display:table-cell">
        <div style="margin-right:10px">Duration (m)</div>
      </td>
      <td class="xl71" width="215" style="border-top:none;width:161pt">
        <div style="margin-right:10px">{duration}</div>
      </td>
      <td class="xl68" width="215" style="border-top:none;width:161pt">
        <div style="margin-right:10px">Production company</div>
      </td>
      <td class="xl71" width="215" style="border-top:none;width:161pt">
    ...
    <tr height="38" style="height:28.5pt">
      <td height="38" class="xl69" width="215" style="height:28.5pt;border-top:none; width:161pt;display:table-cell">
        <div style="margin-right:10px">Country</div>
      </td>
      <td class="xl71" width="215" style="border-top:none;width:161pt">
        <div style="margin-right:10px">{country}</div>
      </td>
    ...
    <tr height="38" style="height:28.5pt">
      ...
      <td class="xl68" width="215" style="border-top:none;width:161pt">
        <div style="margin-right:10px">Average vote</div>
      </td>
      <td class="xl71" width="215" style="border-top:none;width:161pt">
    ...
    <tr height="38" style="height:28.5pt">
      <td height="38" class="xl69" width="215" style="height:28.5pt;border-top:none; width:161pt;display:table-cell">
        <div style="margin-right:10px">Budget</div>
      </td>
      <td class="xl71" width="215" style="border-top:none;width:161pt">
        <div style="margin-right:10px">{budget}</div>
      </td>
